          ...
          <div className="lg:col-span-7 space-y-5 text-left">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
              <button
                ...
                className="px-6 py-3 bg-forest hover:bg-forest-hover text-white text-xs font-bold uppercase tracking-wider rounded-lg flex items-center justify-center gap-2 transition-colors shadow-sm hover:shadow focus-ring touch-target"
              >
