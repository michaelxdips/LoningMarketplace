...
const finalMigrationTag = '0017_product_image_display_order_unique' as const;
const migrationSteps = ['preparePublicIntegrity', preparationMigrationTag, repairMigrationTag, '0010_umkm_business_location', '0011_optional_umkm_image', '0012_standalone_products', '0013_product_images', '0014_relax_public_events_target_check', 'assertPublicIntegrity', 'assertBusinessLocationIntegrity'] as const;
