...
const finalMigrationTag = '0013_product_images' as const;
const migrationSteps = ['preparePublicIntegrity', preparationMigrationTag, repairMigrationTag, '0010_umkm_business_location', '0011_optional_umkm_image', '0012_standalone_products', finalMigrationTag, 'assertPublicIntegrity', 'assertBusinessLocationIntegrity'] as const;
