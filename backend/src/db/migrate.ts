...
const finalMigrationTag = '0012_standalone_products';
const migrationSteps = ['preparePublicIntegrity', preparationMigrationTag, repairMigrationTag, '0010_umkm_business_location', '0011_optional_umkm_image', finalMigrationTag, 'assertPublicIntegrity', 'assertBusinessLocationIntegrity'] as const;
