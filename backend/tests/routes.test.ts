...
import { categories, type PublicProduct, type PublicUMKM, type Repository } from '../src/routes/repository.js';
...
const umkms: PublicUMKM[] = [
  { id: '00000000-0000-4000-8000-000000000001', name: 'UMKM Kuliner Desa', owner: 'Owner A', description: 'Traditional food', phone: '62812', category: 'Kuliner', imageUrl: 'image-a', address: 'Loning' },
  { id: '00000000-0000-4000-8000-000000000002', name: 'Mebel Kayu', owner: 'Owner B', description: 'Furniture', phone: '62813', category: 'Jasa', imageUrl: 'image-b', address: 'Loning', workingHours: '08:00' },
];
const products: PublicProduct[] = [
  { id: '10000000-0000-4000-8000-000000000001', umkmId: umkms[0].id, umkmName: umkms[0].name, name: 'Nasi Box', price: null, description: 'Food', category: 'Kuliner', imageUrl: 'image-a', isAvailable: true },
  { id: '10000000-0000-4000-8000-000000000002', umkmId: umkms[1].id, umkmName: umkms[1].name, name: 'Kursi', price: 100, description: 'Wood', category: 'Jasa', imageUrl: 'image-b', isAvailable: true, unit: 'Unit' },
];
...
const repository = {
  ...
  getUMKM: async (id: string) => umkms.find((item) => item.id === id),
...
describe('public API routes', () => {
  ...
  it('rejects invalid UUIDs and reports missing details', async () => { const app = await buildApp(env, repository); expect((await app.inject('/api/products/not-a-uuid')).statusCode).toBe(400); expect((await app.inject('/api/umkms/00000000-0000-4000-8000-000000000099')).json().error.code).toBe('NOT_FOUND'); await app.close(); });
