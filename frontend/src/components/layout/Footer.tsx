...
export default function Footer() {
  ...
  const developerWaUrl = "https://wa.me/62818139410?text=Halo%20Michael,%20saya%20tertarik%20bertanya%20mengenai%20pengembangan%20website%20Loning%20Maju.";
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-xs text-cream-tint/75">
              ...
              <div className="flex items-start gap-2 pt-2 border-t border-white/10">
                ...
                <div>
                  <p className="font-semibold text-white">Pengembang Platform</p>
                  <a
                    href={developerWaUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="focus-ring text-[11px] text-terracotta hover:underline font-semibold flex items-center gap-1 mt-0.5"
                  >
