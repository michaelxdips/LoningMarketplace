...
export default function FeaturedBusinessesSection({ umkms, searchQuery, onSearchChange, onViewDetails, isLoading, isError, onRetry }: FeaturedBusinessesSectionProps) {
  return (
    <section 
      id="umkm" 
