...
/**
 * Footer V2 (desktop) — seimbang & proporsional penuh.
 */
        ...
        <div className="mx-auto max-w-[1400px] px-6 py-6 lg:px-10">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-12 lg:gap-8">
            ...
            <div className="space-y-1.5 lg:col-span-4">
              ...
              <p className="flex max-w-xs items-start gap-1.5 text-[11px] leading-relaxed text-ink-muted">
            ...
            {/* Kolom 2: Jelajahi (span 3) */}
            <div className="lg:col-span-3">
              <h2 className="text-[10px] font-semibold uppercase tracking-[0.18em] text-accent-ink">
                Jelajahi
              </h2>
              <nav aria-label="Peta situs direktori" className="mt-1.5 grid gap-1 text-xs">
            ...
            <div className="lg:col-span-2">
              ...
              <nav aria-label="Informasi dan akses" className="mt-1.5 grid gap-1 text-xs">
                <Link to="/v2/tentang-desa" className="focus-ring-v2 text-ink-muted transition-colors hover:text-ink">Tentang Desa</Link>
                <Link to="/v2/faq" className="focus-ring-v2 text-ink-muted transition-colors hover:text-ink">Tanya Jawab (FAQ)</Link>
            ...
            {/* Kolom 4: Pengembang (span 3) */}
            <div className="space-y-1.5 lg:col-span-3">
              <h2 className="text-[10px] font-semibold uppercase tracking-[0.18em] text-accent-ink">
                Pengembang
              </h2>
              <p className="text-xs leading-relaxed text-ink-muted">
                Stephen Michael &middot; KKN Reguler Tim II Universitas Diponegoro 2026
              </p>
              <button
                type="button"
          ...
          <div className="mt-5 flex flex-wrap items-center justify-between gap-3 border-t border-line pt-3 text-[11px] text-ink-subtle">
            <p>
