...
export const UNSAVED_CHANGES_MESSAGE =
  'Anda memiliki perubahan yang belum disimpan. Jika meninggalkan halaman, perubahan tersebut akan hilang.';

type PendingNavigation = { href: string } | null;

/**
 * Perlindungan perubahan-belum-tersimpan V2.
 *
 * Logika identik dengan frontend/src/hooks/useUnsavedChanges.tsx; bedanya dialog
 * konfirmasi memakai ConfirmDialog V2. Relatif path karena satu folder dashboard.
 */
