...
export interface UMKMInput { name: string; owner: string; description: string; phone: string; category: Category; imageUrl: string | null; imageAssetId: string | null; address: string; workingHours?: string; openingTime?: string; closingTime?: string; ownerUserId?: string | null }
export interface ProductCreateInput { umkmId?: string | null; phone?: string | null; sellerName?: string | null; name: string; price: number | null; description: string; category: Category; imageUrl: string | null; imageAssetId: string | null; isAvailable: boolean; unit?: string }
